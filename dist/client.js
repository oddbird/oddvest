(function () {
  ...
  */
  ...
  TrelloPowerUp.initialize({
    ...
    'show-settings': function showSettings(t) {
      return t.popup({
    ...
    'card-back-section': function cardBackSection(t) {
      return {
        title: 'Harvest Time',
        icon: GRAY_ICON,
        content: {
    ...
    'card-detail-badges': function cardDetailBadges(t) {
      return getTask(t).then(function (task) {
        return [{
          ...
          text: task ? task.name : 'no task!',
          color: task ? null : 'red',
          callback: function callback(innerT) {
            return innerT.popup({
              title: 'Set Task',
              url: 'set_task.html'
            });
    ...
    'authorization-status': function authorizationStatus(t) {
      return getAuthToken(t).then(function (authToken) {
        return (// TODO actually check if the authToken is valid
          {
    ...
    'show-authorization': function showAuthorization(t) {
      return t.popup({
