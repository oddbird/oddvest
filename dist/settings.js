(function () {
	...
	*/
	...
	var setProjectId = function setProjectId(t, projectId) {
	...
	window.settingsForm.addEventListener('submit', function (event) {
	  ...
	  return setProjectId(t, window.projectId.value).then(function () {
	    t.closePopup();
	  });
	});
	t.render(function () {
	  return getProjectId(t).then(function (currentProjectId) {
