(function () {
	...
	*/
	...
	var setAuthToken = function setAuthToken(t, token) {
	  return (// TODO This API uses localStorage, ideally we'd catch any error here if
	...
	var redirectUri = encodeURIComponent(t.signUrl("".concat(window.origin, "/auth_success.html")));
	var authBtn = document.getElementById('authorize');
	authBtn.addEventListener('click', function () {
	  getClientId(t).then(function (clientId) {
	    return (// eslint-disable-next-line max-len
	      "https://id.getharvest.com/oauth2/authorize?client_id=".concat(clientId, "&response_type=token&redirect_uri=").concat(redirectUri)
	    );
	  }).then(function (oauthUrl) {
	    t.authorize(oauthUrl).then(function (token) {
